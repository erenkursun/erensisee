...
exports.run = async (client, message, args) => {
    ...
    if(!user) return message.reply("<:ok:1088881942725926982> Lütfen Rolün Verileceği Kişiyi Belirtiniz.")
    if(!rol) return message.reply("<:ok:1088881942725926982> Lütfen Verilicek Rolü Belirtiniz.")
