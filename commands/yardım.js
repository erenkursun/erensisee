...
.setDescription("**p!herkeserolver | **p!herkesten-rol-al |** Sunucudaki Herkesten Belirlediğiniz Rolü Alır!\n**p!fake-mesaj |** Belirlediğiniz Kullanıcıyı Etiketleyip Mesaj Bırakırsanız Bot Size Özel Webhook Oluşturup O Kanala Fake Mesaj Gönderir.\n**p!küfürengel |** Küfür engelleme sistemini ayarlamanızı sağlar\n**p!reklamengel |** Reklam engelleme sistemini ayarlamanızı sağlar\n**p!oto-cevap |** Belirtilen yazıyı biri yazarsa bot belirtilen cevabı vermeye ayarlanır\n**p!otorol |** Sunucuya girenlere verilecek olan otorolü ayarlar\n**p!ototag |** Bot belirtilen tagı sunucuya girenlerin isimlerinin başına koyar\n**p!sa-as |** Oto sa-ası ayarlarsınız\n**p!sayaç |** Sayacı ayarlarsınız\n**p!partner-system |** Partner Komutlarına Bakarsınız\n**p!partner-kanal |** Partner Kanalını Ayarlarsınız\n**p!partner-log |** Partner Log Kanalını Ayarlarsınız\n**p!partner-ol |** Sunucu İd Sini Girerek O Sunucuyla Partner Olursunuz\n**p!partner-yazı |** Partner Text'inizi Ayarlarsınız\n")
message.channel.send({embeds: [embed]})
const embed2 = new diskord.EmbedBuilder()
